  ...
  return (
    <AnimatePresence>
      <>
        ...
        {/* Modal Content */}
        <div
          className="fixed inset-8 md:inset-12 lg:inset-16 z-[101] flex items-center justify-center"
          onClick={onClose}
        >
          <motion.div
            ...
            className="relative w-full max-w-7xl bg-[var(--bg-base)] shadow-2xl shadow-[var(--accent-primary)]/20 max-h-full overflow-hidden"
            style={{
