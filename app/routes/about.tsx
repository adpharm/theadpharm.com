...
export function meta({}: Route.MetaArgs) {
  ...
  const description =
    "Learn about The AdPharm's mission, foundation, and leadership team. A full service pharmaceutical advertising agency with 20+ years of experience.";
