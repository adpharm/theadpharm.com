...
export function useTheme() {
  ...
  useEffect(() => {
    if (rootData?.preferences?.theme && rootData.preferences.theme !== theme) {
      setThemeState(rootData.preferences.theme);
      updateDOMClass(rootData.preferences.theme);
    }
  }, [rootData?.preferences?.theme]);
