...
// export function GameBoard({ userId }: { userId: number | undefined }) {
...
//   //     try {
//   //       setIsLoading(true);
//   //       const result = await actions.christmas21Questions.checkGamesRemaining(userId);
//   //       if (result.success && result.data) {
//   //         setGamesData(result.data);
//   //         setGamesRemaining(result.data.gamesRemaining);
//   //       } else {
...
//   //   setIsLoading(true);
//   //   try {
//   //     const result = await actions.christmas21Questions.newcheckGamesRemaining();

//   //     if (result.success && result.data) {
//   //       setGamesRemaining(result.data.gamesRemaining);
//   //       return result.data.gamesRemaining > 0; // Return if games are remaining
//   //     } else {
//   //       setError("Failed to check remaining games.");
//   //       return false;
//   //     }
//   //   } catch (err) {
...
import { motion, AnimatePresence } from "framer-motion";
import { CustomTooltip } from "./Tooltip";
import type { User } from "@/lib/server/actions.user";
