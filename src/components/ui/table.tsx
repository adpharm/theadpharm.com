...
>(({ className, ...props }, ref) => (
  <div className="relative w-full overflow-auto group-[.winter]:pt-2 group-[.winter]:px-1">
    <table
      ref={ref}
    ...
    <img
      ...
      className="hidden group-[.winter]:block absolute left-0 top-0 h-12 object-contain"
    />
    <img
      src="/plinko/other/SnowTopRight.webp"
      className="hidden group-[.winter]:block absolute right-0 top-0 h-12 object-contain"
    />
  </div>
));
